...
help :-
    ...
    write('% 10. fertilizer.         : Mempercepat pertumbuhan tanaman sebanyak 1 hari          %\n'),
    write('% 11. good_fertilizer.    : Mempercepat pertumbuhan tanaman 50 % dari waktu tumbuh   %\n'),
    write('% 12. best_fertilizer.    : Mempercepat pertumbuhan tanaman 75 % dari waktu tumbuh   %\n'),
    write('% 13. instant_fertilizer. : Menumbuhkan tanaman apapun sebanyak 1 hari               %\n'),
    write('% 14. potionBreedSheep.   : Potion agar domba dapat mengandung                       %\n'),
    write('% 15. potionBreedCow.     : Potion agar sapi dapat mengandung                        %\n'),
    write('%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%\n'),
    write('%                            ~Item Fishing~                                          %\n'),
...
help :-
    ...
    write('%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%\n'),
    write('%                              ~Farming~                                             %\n'),
    write('% - ranch.          : Memasuki ranch milikmu                                         %\n'),
    write('%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%\n'),!.
help :-
    playerCell(C),
    state(house),
