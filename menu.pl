...
help :-
    ...
    write('% 6. tuna        : Memiliki kemungkinan sebesar 5 % pada level 1 untuk ditangkap.   %\n'),
    write('% 7. barracuda   : Memiliki kemungkinan sebesar 2 % pada level 1 untuk ditangkap.   %\n'),
    write('% 8. hiu         : Memiliki kemungkinan sebesar 1 % pada level 1 untuk ditangkap.   %\n'),
    write('% 9. normal_rod  : Dibutuhkan untuk fishing ikan lele dan nila, tiap fishing        %\n'),
    write('%                  bertambah 10 fishing exp                                         %\n'),
    write('% 10. good_rod   : Dibutuhkan untuk fishing ikan lele, nila, gurame, dan patin,     %\n'),
    write('%                  tiap fishing bertambah 15 fishing exp                            %\n'),
    write('% 11. rare_rod   : Dibutuhkan untuk fishing ikan lele, nila, gurame, patin, salmon, %\n'),
    write('%                  dan tuna, tiap fishing bertambah 20 fishing exp                  %\n'),
    write('% 12. legend_rod : Dibutuhkan untuk fishing semua ikan terutama legendary fish      %\n'),
